export default {
  'game': {
    'bossBanner': 'مرحلة الزعيم!',
    'saiyan': {
      'verb': 'آاااه!',
      'hint': 'انقر بسرعة لرفع مستوى قوتك',
      'pump': 'اضخّ!',
      'over': 'تجاوز 9000!'
    },
    'cat': {
      'verb': 'داعب!',
      'hint': 'انقر كل شرارة لحظة انغلاق الحلقة',
      'zap': 'زقّ!'
    },
    'window': {
      'verb': 'أغلق!',
      'hint': 'اسحب المقبض وأغلقها بعنف',
      'slam': 'صفق!'
    },
    'flashlight': {
      'verb': 'اضرب!',
      'hint': 'اضربها ثلاث مرات على الإيقاع',
      'whack': 'صفعة!'
    },
    'toast': {
      'verb': 'التقط!',
      'hint': 'التقط الشريحتين في الهواء'
    },
    'soda': {
      'verb': 'انقر!',
      'hint': 'انقر 3 مرات ثم افتح الغطاء',
      'spray': 'رشّ!'
    },
    'router': {
      'verb': 'وصّل!',
      'hint': 'اسحب القابس إلى المقبس'
    },
    'mosquito': {
      'verb': 'اصفع!',
      'hint': 'انقر لحظة انغلاق الحلقة',
      'smack': 'صفعة!'
    },
    'stomp': {
      'verb': 'ادهس!',
      'hint': 'اسحق كل حشرة قبل نفاد الوقت',
      'splat': 'لطخة!'
    },
    'mirage': {
      'verb': 'اضرب!',
      'hint': 'اضرب اليربوع الحقيقي، لا السراب',
      'boop': 'بوب!'
    },
    'thermometer': {
      'verb': 'برّد!',
      'hint': 'انقر مكعبات الثلج بالترتيب عند انغلاق الحلقات',
      'boiling': 'نقطة الغليان'
    },
    'potato': {
      'verb': 'ارمِ!',
      'hint': 'انقر اليد الفارغة لترمي قبل أن تحترق',
      'ouch': 'آخ!'
    },
    'fan': {
      'verb': 'روّح!',
      'hint': 'انقر على الإيقاع لتطرد الحرارة',
      'stress': 'حرارة'
    },
    'shadow': {
      'verb': 'اقفز!',
      'hint': 'انقر الظل لتقفز عن الأنبوب الساخن',
      'phew': 'أوف!',
      'burn': 'ساخن!'
    },
    'signal': {
      'verb': 'اضبط!',
      'hint': 'أدر الهوائي للعثور على الإشارة',
      'tune': 'بحث',
      'hold': 'اثبت!'
    }
  },
  'desk': {
    'prompt': 'اضغط المسافة لتحلم'
  },
  'summary': {
    'morning': 'الصباح!',
    'lightsOut': 'أُطفئت الأنوار.',
    'ideas': 'من أفكار الثالثة فجرا تحققت',
    'best': 'الأفضل:',

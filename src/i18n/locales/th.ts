export default {
  'game': {
    ...
    'saiyan': {
      'verb': 'อาาาก!',
      'hint': 'รัวให้เร็วเพื่อเพิ่มพลัง',
      'pump': 'ปั๊ม!',
      'over': 'เกิน 9000 แล้ว!'
    },
    'cat': {
      'verb': 'ลูบ!',
      'hint': 'แตะประกายไฟตอนวงแหวนหุบพอดี',
      'zap': 'แช้ก!'
    },
    'window': {
      'verb': 'ปิด!',
      'hint': 'ลากที่จับแล้วกระแทกปิด',
      'slam': 'ปัง!'
    },
    'flashlight': {
      'verb': 'ตบ!',
      'hint': 'ตบสามครั้งเป็นจังหวะ',
      'whack': 'เพี้ยะ!'
    },
    'toast': {
      'verb': 'รับ!',
      'hint': 'รับขนมปังทั้งสองแผ่นกลางอากาศ'
    },
    'soda': {
      'verb': 'แตะ!',
      'hint': 'แตะ 3 ครั้งแล้วเปิดฝา',
      'spray': 'เพล้ง!'
    },
    'router': {
      'verb': 'เสียบเลย!',
      'hint': 'ลากปลั๊กไปที่เต้ารับ'
    },
    'mosquito': {
      'verb': 'ตบ!',
      'hint': 'แตะตอนวงแหวนหุบพอดี',
      'smack': 'เพี้ยะ!'
    },
    'stomp': {
      'verb': 'เหยียบ!',
      'hint': 'บี้แมลงทุกตัวก่อนหมดเวลา',
      'splat': 'ปั้ก!'
    },
    'mirage': {
      'verb': 'ตบ!',
      'hint': 'ตบเจอร์บัวตัวจริง ไม่ใช่ภาพลวงตา',
      'boop': 'ปุ๊บ!'
    },
    'thermometer': {
      'verb': 'ทำให้เย็น!',
      'hint': 'แตะน้ำแข็งตามลำดับเมื่อวงแหวนหุบ',
      'boiling': 'จุดเดือด'
    },
    'potato': {
      'verb': 'โยน!',
      'hint': 'แตะมือที่ว่างเพื่อโยนก่อนจะไหม้',
      'ouch': 'โอ๊ย!'
    },
    'fan': {
      'verb': 'พัด!',
      'hint': 'แตะตามจังหวะเพื่อพัดไล่ความร้อน',
      'stress': 'ร้อน'
    },
    'shadow': {
      'verb': 'กระโดด!',
      'hint': 'แตะเงาเพื่อกระโดดจากท่อร้อน',
      'phew': 'เฮ่อ!',
      'burn': 'ร้อน!'
    },
    'signal': {
      'verb': 'จูนคลื่น!',
      'hint': 'หมุนเสาอากาศหาสัญญาณ',
      'tune': 'ค้นหา',
      'hold': 'นิ่งไว้!'
    }
  },
  'desk': {
    'prompt': 'กดสเปซเพื่อฝัน'
  },
  'summary': {
    'morning': 'เช้าแล้ว!',
    'lightsOut': 'ปิดไฟ',
    'ideas': 'ไอเดียตีสามที่ทำให้เป็นจริง',
    'best': 'สถิติ:',
    'newBest': 'สถิติใหม่!',
    'again': 'อดหลับอีกคืนไหม?'
  },
  'ads': {
